# 💫 Hi, I'm Koo:
I am a full-stack developer specialising in React (Context API, tanStack hooks), NextJS (server-side rendering, server actions), TypeScript, NodeJS and PostgreSQL. I am also learning to use Python for its versatility and comprehensive AI/ML libraries, Docker for containerisation and rapid scalable deployment and Redis for real-time data management.<br><br>Currently, I am building a Progressive Web App (PWA) for Breathwork practice with React + Vite and TypeScript. You can follow my progress at https://github.com/Roodbaraky/NafasApp or my updates on LinkedIn [#ProjectNafas](https://www.linkedin.com/feed/hashtag/?keywords=projectnafas)
